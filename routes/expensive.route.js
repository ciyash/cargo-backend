...
router.put("/expenses/:id", expensiveController.updateExpense);   
...
router.put("/expense-types/:id", expensiveController.updateExpenseType);
...
router.put("/account-cat/:id", expensiveController.updateAccountCat);  
...
router.put("/customers/:id", expensiveController.updateCustomer);  
